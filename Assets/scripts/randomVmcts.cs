...
public class randomVmcts : MCTSbyclicks
{
    ...
    public void randomButton()
    {
        ...
        else
        {
            ...
            checkFinished(playerOnePass, playerTwo.GameOver);
        }
    }

    public void playerTurn(List<object> BoardState)
    {
        var playerTwo = playerTwoTurn(BoardState);
        BoardState = playerTwo.BoardState;
        applyMove(BoardState);
        ...
        List<int[]> playerTwoMovesTaken, gameState swap, int[] moveRemoved)
    {
        ...
        allBoardPositions = MCTSscript.removeFromAllBoardPositions(allBoardPositions, moveRemoved);
