...
public class MCTSscript: MonoBehaviour
{
    ...
    public static (List<object> move,bool GameOver) computerMove(List<object> BoardState)
    {
        ...
        try
        {
            rootNode = new NodeMCTS(BoardState);
        }
        catch
        {
            BoardState[7] = null;
            BoardState[6] = gameState.PLAYERTWO;
            return (BoardState, true);
        }

        if (rootNode.board.availableMoves.Count == 0)
        {
            BoardState[7] = null;
            BoardState[6] = gameState.PLAYERTWO;
            return (BoardState, true);
    ...
    public static int Simulate(NodeMCTS n)
    {
        ...
        allBoardPositions = new List<int>(initAllBoardPos);
    ...
    public static bool isSwap2(Dictionary<int,int> playerTiles)
    {
        ...
        int smallestTile = pVp.GetSmallestTile(playerTiles);
